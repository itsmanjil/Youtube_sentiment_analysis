...
The EnsembleWeightOptimizer/FuzzyParameterOptimizer/HyperparameterTuner
wrapper classes below are exploratory scaffolding: they are exercised only
by demo.py's synthetic-data demo, are never called by any script that
produces a results/ or results/runtime/ artifact, and must not be read as
